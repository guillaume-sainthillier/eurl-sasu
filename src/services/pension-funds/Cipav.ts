...
/**
 * CIPAV Pension Fund Calculator
 * For liberal professionals (professions libérales)
 * Source: https://www.lacipav.fr/
 */
export default class Cipav implements PensionFundBase {
  PASS: number = 39732
  revenus: number
  ...
  // INVALIDITÉ DÉCÈS
  getInvaliditeDeces(classe: string = 'C'): number {
    switch (classe) {
      case 'A':
        return 76
      case 'B':
